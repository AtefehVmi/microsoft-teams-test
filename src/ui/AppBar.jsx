...
function AppBar() {
  const [isActive, setIsActive] = useState("/vanarsdel");
      ...
      <nav>
        <ul className="flex flex-col items-center justify-center">
          ...
          >
            ...
            >
              <path
                ...
                className={
                  isActive === "/activity"
                    ? "fill-neutralForeground3Selected"
                    : "fill-neutralForeground3"
                }
              />
            </svg>
          </TabItem>
          ...
          <TabItem
            name="Van Arsdel"
            to="/vanarsdel"
            isActive={isActive === "/vanarsdel"}
            onClick={() => makeActive("/vanarsdel")}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
